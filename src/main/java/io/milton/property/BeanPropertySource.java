...
//import java.beans.PropertyDescriptor; XXXXX
...
public class BeanPropertySource implements PropertySource {
	...
	public List<QName> getAllPropertyNames(Resource r) {
		...
		PropertyDescriptor[] pds = org.mini2Dx.beanutils.PropertyUtils.getPropertyDescriptors(r);//PropertyUtils.getPropertyDescriptors(r);
	...
	public PropertyDescriptor getPropertyDescriptor(Resource r, String name) {
		try {
			PropertyDescriptor pd = org.mini2Dx.beanutils.PropertyUtils.getPropertyDescriptor(r, name);//PropertyUtils.getPropertyDescriptor(r, name);
			return pd;
